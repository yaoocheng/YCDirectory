                        ...
                        {session && session?.user ? (
                            ...
                            <div className='flex items-center gap-4'>
                                ...
                                <button className='cursor-pointer' onClick={async () => {
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-gray-700 hover:text-black transition-colors">
                                ...
                                <button className='cursor-pointer' onClick={async () => {
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" className="text-gray-700 hover:text-black transition-colors">
