...
const Page = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const userRes = await fetch(`https://yc-directory-yccccc.vercel.app/api/user-query/${id}`, {
    method: "GET",
    cache: "no-cache",
  });
  ...
  const res = await fetch(`https://yc-directory-yccccc.vercel.app/api/startup-user/${id}`, {
    method: "GET",
    cache: "no-cache",
  });
