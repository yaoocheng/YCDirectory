...
async function page({ params }: { params: { id: string } }) {
    ...
    const response = await fetch(`https://yc-directory-yccccc.vercel.app/api/startup-query/${id}`, {
    ...
    const sameResponse = await fetch(`https://yc-directory-yccccc.vercel.app/api/startup-same/${id}`, {
        cache: 'no-store' // 确保每次都获取最新数据
    });
